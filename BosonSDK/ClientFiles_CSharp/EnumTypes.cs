...
namespace Boson {
	public partial class Camera {
		...
		public enum FLR_TEMPERATURE_UNIT_E : int {
		...
		public enum FLR_BOSON_TABLETYPE_E : int {
		...
		public enum FLR_CAPTURE_STATE_E : int {
			FLR_CAPTURE_READY = 0,
		...
		public enum FLR_DVO_LCD_CLOCK_RATE_E : int {
		...
		public enum FLR_ISOTHERM_REGION_E : int {
		...
		public enum FLR_RADIOMETRY_RBFO_TYPE_E : int {
			FLR_RADIOMETRY_DEFAULT_RBFO = 0,
			FLR_RADIOMETRY_FACTORY_RBFO = 1,
		}
		
		public enum FLR_RADIOMETRY_UNCERTAINTY_FACTOR_E : int {
		...
		public enum FLR_SCNR_CORR_SELECT_E : int {
			FLR_SCNR_STD_CORR = 0,
			FLR_SCNR_ABS_DIFF_CORR = 1,
			FLR_SCNR_CORR_END = 2,
		}
		
		public enum FLR_SCNR_MODE_E : int {
			FLR_SCNR_MODE_M = 0,
			FLR_SCNR_MODE_I = 1,
		...
		public enum FLR_SPNR_ALGORITHM_E : int {
			FLR_SPNR_ALGO_DWT = 0,
			FLR_SPNR_ALGO_DEFAULT = 0,
			FLR_SPNR_ALGO_ITER = 1,
		}
		
		public enum FLR_SPOTMETER_STATS_TEMP_MODE_E : int {
		...
		public enum FLR_SYSCTRL_USBIR16_MODE_E : int {
		...
		public enum FLR_SYSCTRL_OPERATING_MODE_E : int {
		...
		public enum FLR_SYSINFO_SW_CONFIG_ID_E : int {
		...
		public enum FLR_SYSINFO_SW_PERMISSIONS_E : int {
		...
		public enum FLR_TELEMETRY_ORDER_E : int {
		...
		public enum FLR_UART_STARTUP_BAUDRATE_E : int {
