...
void byteToFLR_SYSTEMSYMBOLS_SPOTCONFIG_T(const uint8_t *inBuff, FLR_SYSTEMSYMBOLS_SPOTCONFIG_T *outVal) {
    ...
    byteToFLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T((const uint8_t *)ptr,&(outVal->greenBarFilling));
    ptr += 15;
...
void FLR_SYSTEMSYMBOLS_SPOTCONFIG_TToByte(const FLR_SYSTEMSYMBOLS_SPOTCONFIG_T *inVal, const uint8_t *outBuff) {
    ...
    FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_TToByte(&(inVal->greenBarFilling),(const uint8_t *)ptr);
    ptr += 15;
...
void byteToFLR_SYSTEMSYMBOLS_ISOCONFIG_T(const uint8_t *inBuff, FLR_SYSTEMSYMBOLS_ISOCONFIG_T *outVal) {
    ...
    byteToFLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T((const uint8_t *)ptr,&(outVal->colorBar1));
    ptr += 15;
    
    if(ptr-inBuff>=45) {
        return;// R_CAM_PKG_BUFFER_OVERFLOW;
    }
    byteToFLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T((const uint8_t *)ptr,&(outVal->colorBar2));
    ptr += 15;
...
void FLR_SYSTEMSYMBOLS_ISOCONFIG_TToByte(const FLR_SYSTEMSYMBOLS_ISOCONFIG_T *inVal, const uint8_t *outBuff) {
    ...
    FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_TToByte(&(inVal->colorBar1),(const uint8_t *)ptr);
    ptr += 15;
    
    if((ptr-outBuff)>=45) {
        return;// R_CAM_PKG_BUFFER_OVERFLOW;
    }
    FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_TToByte(&(inVal->colorBar2),(const uint8_t *)ptr);
    ptr += 15;
