...
FLR_RESULT gaoSetRnsThDamp(const uint16_t thDamp){
    FLR_RESULT returncode = CLIENT_pkgGaoSetRnsThDamp(thDamp);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoGetRnsThDamp(uint16_t *thDamp){
    FLR_RESULT returncode = CLIENT_pkgGaoGetRnsThDamp(thDamp);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoSetRnsThException(const uint16_t thException){
    FLR_RESULT returncode = CLIENT_pkgGaoSetRnsThException(thException);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoGetRnsThException(uint16_t *thException){
    FLR_RESULT returncode = CLIENT_pkgGaoGetRnsThException(thException);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoSetRnsThBad(const uint16_t thBad){
    FLR_RESULT returncode = CLIENT_pkgGaoSetRnsThBad(thBad);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoGetRnsThBad(uint16_t *thBad){
    FLR_RESULT returncode = CLIENT_pkgGaoGetRnsThBad(thBad);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoSetRnsThBadInitial(const uint16_t thBadInitial){
    FLR_RESULT returncode = CLIENT_pkgGaoSetRnsThBadInitial(thBadInitial);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoGetRnsThBadInitial(uint16_t *thBadInitial){
    FLR_RESULT returncode = CLIENT_pkgGaoGetRnsThBadInitial(thBadInitial);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoSetRnsThAllowedExceptions(const uint16_t thAllowedExceptions){
    FLR_RESULT returncode = CLIENT_pkgGaoSetRnsThAllowedExceptions(thAllowedExceptions);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoGetRnsThAllowedExceptions(uint16_t *thAllowedExceptions){
    FLR_RESULT returncode = CLIENT_pkgGaoGetRnsThAllowedExceptions(thAllowedExceptions);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
...
FLR_RESULT gaoGetRnsFramesExceptionLimitReached(uint32_t *framesReached){
    FLR_RESULT returncode = CLIENT_pkgGaoGetRnsFramesExceptionLimitReached(framesReached);
    // Check for any errorcode
    if((uint32_t) returncode){
        return returncode;
    }
