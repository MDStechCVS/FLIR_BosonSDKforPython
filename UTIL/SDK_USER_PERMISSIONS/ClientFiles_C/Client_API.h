...
FLR_EXPORT FLR_RESULT gaoSetCombineMeansEnableState(const FLR_ENABLE_E data);
FLR_EXPORT FLR_RESULT gaoGetCombineMeansEnableState(FLR_ENABLE_E *data);
...
FLR_EXPORT FLR_RESULT bosonSet2ptResponsivityHighLimit(const float responsivityHighLimit);
FLR_EXPORT FLR_RESULT bosonGet2ptResponsivityHighLimit(float *responsivityHighLimit);
FLR_EXPORT FLR_RESULT bosonSet2ptResponsivityLowLimit(const float responsivityLowLimit);
FLR_EXPORT FLR_RESULT bosonGet2ptResponsivityLowLimit(float *responsivityLowLimit);
FLR_EXPORT FLR_RESULT bosonGet2ptResponsivityHighLimitErrorCount(uint32_t *responsivityHighLimitErrorCount);
FLR_EXPORT FLR_RESULT bosonGet2ptResponsivityLowLimitErrorCount(uint32_t *responsivityLowLimitErrorCount);
FLR_EXPORT FLR_RESULT bosonGet2ptPixelHighLimit(uint32_t *pixelHighLimit);
FLR_EXPORT FLR_RESULT bosonSet2ptPixelHighLimit(const uint32_t pixelHighLimit);
FLR_EXPORT FLR_RESULT bosonGet2ptPixelLowLimit(uint32_t *pixelLowLimit);
FLR_EXPORT FLR_RESULT bosonSet2ptPixelLowLimit(const uint32_t pixelLowLimit);
FLR_EXPORT FLR_RESULT bosonGet2ptPixelHighLimitErrorCount(uint32_t *pixelHighLimitErrorCount);
FLR_EXPORT FLR_RESULT bosonGet2ptPixelLowLimitErrorCount(uint32_t *pixelLowLimitErrorCount);
FLR_EXPORT FLR_RESULT bosonGet2ptTotalBadPixelErrorCount(uint32_t *totalBadPixelErrorCount);
FLR_EXPORT FLR_RESULT bosonGet2ptNucStatusState(uint32_t *statusState, uint32_t *statusStringLength);
FLR_EXPORT FLR_RESULT bosonSet2ptNucStatusState(const uint32_t statusState);
FLR_EXPORT FLR_RESULT bosonReset2ptNucStatusState();
FLR_EXPORT FLR_RESULT bosonGet2ptNucStatusStateString(const uint32_t statusState, const uint16_t sizeInBytes, uint8_t *data);
FLR_EXPORT FLR_RESULT bosonGet2ptNucResultCode(uint32_t *resultCode, uint32_t *resultStringLength);
FLR_EXPORT FLR_RESULT bosonGet2ptNucResultString(const uint32_t resultNumber, const uint16_t sizeInBytes, uint8_t *data);
FLR_EXPORT FLR_RESULT boson2ptNucStart();
FLR_EXPORT FLR_RESULT boson2ptNucNext();
FLR_EXPORT FLR_RESULT boson2ptNucAbort();
...
FLR_EXPORT FLR_RESULT bosonSet2ptFrameStdClipValue(const float frameStdClipValue);
FLR_EXPORT FLR_RESULT bosonGet2ptFrameStdClipValue(float *frameStdClipValue);
...
FLR_EXPORT FLR_RESULT colorLutSetOutlineDisplay(const FLR_ENABLE_E data);
FLR_EXPORT FLR_RESULT colorLutGetOutlineDisplay(FLR_ENABLE_E *data);
